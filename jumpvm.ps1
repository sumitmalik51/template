...
$username = "$($creds.AzureUserName)"
$password = "$($creds.AzurePassword)"
$deployID = "$($creds.DeploymentID)"
...
$vnet1name='onpremises-rg-vnet'
$vnet2name='cloud-rg-vnet'
